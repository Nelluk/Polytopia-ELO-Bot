#!/usr/bin/env python3
"""Plan, verify, or explicitly apply the development keep-active column."""
...
from modules import game_keep_active_migration as migration
...
def main(argv=None):
    ...
    try:
        ...
        plan = (
            ...
            if args.apply else migration.inspect_migration(connection, target=target)
        )
