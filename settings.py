...
config = {'default':
        ...
        447883341463814144:                           # Polychampions
                     {'helper_roles': ['Mod', 'Helper', 'ELO-Helper', 'Team Leader'],
                      ...
                      'bot_channels_private': [487304043786665986, 469027618289614850, 531636068739710997, 447902433964851210, 627601961046507541],  # 986 elo-staff-talk, 850 dont-timeout, 997 novas, 210 s4-drafts
...
lobbies = [{'guild': 283436219780825088, 'size_str': '1v1', 'size': [1, 1], 'ranked': True, 'remake_partial': True, 'notes': '**Newbie game** - 1075 elo max'},
           ...
           {'guild': 447883341463814144, 'size_str': '2v2', 'size': [2, 2], 'ranked': False, 'exp': 95, 'remake_partial': False, 'role_locks': [696841367103602768, 696841359616901150], 'notes': '**Newbie game**: Nova Red vs Nova Blue'},
           {'guild': 447883341463814144, 'size_str': '2v2', 'size': [2, 2], 'ranked': False, 'exp': 95, 'remake_partial': False, 'role_locks': [696841359616901150, 696841367103602768], 'notes': '**Newbie game**: Nova Blue vs Nova Red'},
