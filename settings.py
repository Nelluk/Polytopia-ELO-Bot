...
config = {'default':
          ...
          447883341463814144:                           # Polychampions
                     {'helper_roles': ['Helper', 'ELO-Helper', 'Team Leader'],
                      ...
                      'game_channel_categories': [488421911529914368, 514141474229846018, 519131761733795841, 550414365044637712]},  # elo-games-i, ii, iii, iv
          283436219780825088:                           # Main Server
                     {'helper_roles': ['ELO-Helper', 'Bot Master', 'Director'],
                      ...
                      'game_channel_categories': [546527176380645395, 551747728548298758, 551748058690617354]},
